...
export const config = {
    ...
    beforeFeature: function (uri, feature) {
         //console.log('Before Feature: ' + uri);
        console.log("ini dieksekusi sebelum feature dijalankan, contoh implementasi sperti setup data di database");
    },
    /**\
     *
    ...
    // implementing screenshot when test failed
    afterScenario: async function (world, result, context) {
        console.log("ini dieksekusi setelah scenario, biasanya dimanfaatkan untuk screenshot faoled test")
    ...
    // result=hasil eksekusi dari scenario (passed, failed, skipped)
    /**
     *
